...
class OHCircleSegue: UIStoryboardSegue, CAAnimationDelegate {
    ...
    private static let expandDur: CFTimeInterval = 0.60 // Change to make transition faster/slower
    ...
    override init(identifier: String?, source: UIViewController, destination: UIViewController) {
        ...
        let centerX:CGFloat = 187.5 //UIScreen.main.bounds.width*0.5
        let centerY:CGFloat = 552 //UIScreen.main.bounds.height*0.5
